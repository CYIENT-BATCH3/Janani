VR BASED MOBILE FUNCTIONALITY ACCESS
...
*********************
1.start
2.in main function call mobile function
3.in mobile function read input and select phone,camera and music function
4.in music function perform music related tasks
5. in phone function perform related tasks
6. in camera function perform camera related tasks
